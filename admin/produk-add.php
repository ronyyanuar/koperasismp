...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  $insertMessage = insertProduct($nama, $harga);
}
?>
    ...
    <div class="main-wrapper">
      ...
      <main class="main users chart-page" id="skip-target">
        ...
        <?php if (isset($insertMessage)) : ?>
            <div class="alert <?php echo ($insertMessage == 'Data berhasil ditambahkan.') ? 'alert-success' : 'alert-danger'; ?> alert-dismissible fade show" role="alert">
                <?php echo $insertMessage; ?>
                <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
            </div>
        <?php endif; ?>
          <h2 class="main-title">Input Produk</h2>
          <div class="row">
            <div class="col-lg-11">
